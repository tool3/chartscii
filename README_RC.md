...
**Six chart types. Twenty themes. Gradients, animations, and rich text — all in pure terminal output.**
...
[![license](https://img.shields.io/npm/l/chartscii)](./LICENSE)
...
There's an officially supported CLI: [`chartscii-cli`](https://github.com/tool3/chartscii-cli).

```bash
npm install -g chartscii-cli
echo '1 2 3 4 5' | chartscii --type bar --theme pastel
```
