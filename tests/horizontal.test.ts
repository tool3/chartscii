...
describe('horizontal', () => {
    test('should match example', async () => {
    ...
    test('should support labeless chart', async () => {
        const data = generateChartData();
    ...
    test('should scale according to height', async () => {
        const data = generateChartData();
