...
describe('scale', () => {
    ...
    test('should support char of different widths', async () => {
    ...
    test('should support char and fill of different widths', async () => {
    ...
    test('should support char and fill of different widths non equally', async () => {
        const chart = new Chartscii(data, { width: 100, color: 'pink', char: '🔥', fill: '+', colorLabels: true, orientation: 'vertical', });
        await snap(chart.create(), 'scale char widths non equal');
    });

    test('should support char and fill of different widths non equally reversed', async () => {
    ...
    test('should support padding and width', async () => {
    ...
    test('should support padding and barSize', async () => {
    ...
    test('should support percentage', async () => {
    ...
    test('should support auto label placement', async () => {
